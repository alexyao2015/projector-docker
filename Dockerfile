...
# install specific packages for IDEs:
    ...
    && if [ "${downloadUrl#*pycharm}" != "$downloadUrl" ]; then apt-get install python2 python3.8 python3.9 python3.10 python3-distutils python3-pip python3-setuptools -y; else echo "Not pycharm"; fi \
